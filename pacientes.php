    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <button class="btn btn-sm btn-primary" style="background: none;border: none;" data-toggle="modal" data-target="#ModalNuevo" title="Nuevo Paciente">
            ...
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                  <h5 class="modal-title" id="exampleModalLabel">Nuevo Paciente <span class="fa fa-plus"></span></h5>
                ...
                <form action="#" id="form_nuevo">
                  ...
                  <div class="row">
                      ...
                      <div class="form-group col-md-6 col-sm-12">
                          ...
                          <textarea name="direccion" id="direccion" cols="30" rows="2" class="form-control" onkeyup="mayus(this);" onkeypress="return validar_string_direccion(event);" maxlength="50"></textarea>
                      </div>
                  </div>
                  </form>
              </div>
          ...
          <div class="modal fade" id="ModalEditar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                  <h5 class="modal-title" id="exampleModalLabel">Editar Paciente <span class="fa fa-plus"></span></h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
        ...
        <!-- Modal Ver-->
          <div class="modal fade" id="ModalVer" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                  <h5 class="modal-title" id="exampleModalLabel">Ver Paciente <span class="fa fa-eye"></span></h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
...
<?php include('includes/footer.php'); ?>
  ...
  <script>
    function cargar_tabla(){
      $('#cargar_tabla').load('includes/tablaPacientes.php');
    }
    cargar_tabla();
    ...
    function eliminar(id){
      ...
      buttonsStyling: false
            ...
            $.ajax({
                url:"process/eliminarPaciente.php",
                type:"POST",
                data: 'id='+id,
    ...
    function guardar(){
        ...
        $.ajax({
          url:"process/guardarPaciente.php",
          type:"POST",
    ...
    function editar(id,dni,nombre,apellido,telefono,direccion,email){
     ...
     function update(){
        ...
        $.ajax({
          url:"process/updatePaciente.php",
          type:"POST",
